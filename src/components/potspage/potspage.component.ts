...
@Component({
  ...
  imports: [CommonModule, PotscategoryComponent, DiscountComponent, RouterLink, NavbarComponent, FormsModule, FooterComponent],
...
export class PotspageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      if (categoryParam && categoryParam !== 'gift & combos') {
        this.selectedCategory = categoryParam;
      } else if (currentPath === '/potspage') {
        this.selectedCategory = 'pots and accesories';
      }
    });
